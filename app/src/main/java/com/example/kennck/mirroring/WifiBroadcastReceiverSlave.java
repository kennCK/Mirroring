...
public class WifiBroadcastReceiverSlave extends BroadcastReceiver {
    private final String TAG = "BroadcastReceiver";
    private WifiP2pManager mManager;
    private WifiP2pManager.Channel mChannel;
    private WifiHandler activity;

    public WifiBroadcastReceiverSlave(WifiP2pManager manager, WifiP2pManager.Channel channel, WifiHandler activity) {
        super();
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if(networkInfo.isConnected()){
                ...
                if(activity == null){
                    ...
                    Toast.makeText(activity, "Network Device Disconnected", Toast.LENGTH_LONG).show();
                }
            }
